...
#ifndef PoMuSPhysicsListMessenger_h
#define PoMuSPhysicsListMessenger_h 1

#include "globals.hh"
#include "G4UImessenger.hh"

class PoMuSPhysicsList;
class G4UIdirectory;
...
class PoMuSPhysicsListMessenger: public G4UImessenger
{
  public:
  
    PoMuSPhysicsListMessenger(PoMuSPhysicsList*);
   ~PoMuSPhysicsListMessenger();
    
    virtual void SetNewValue(G4UIcommand*, G4String);
    
  private:
  
    PoMuSPhysicsList*        fPhysList;
