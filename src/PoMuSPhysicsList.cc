...
//
// $Id: PhysicsList.cc 93739 2015-10-30 11:04:09Z gcosmo $
//
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

#include "PoMuSPhysicsList.hh"
#include "PoMuSPhysicsListMessenger.hh"
...
PoMuSPhysicsList::PoMuSPhysicsList() : G4VModularPhysicsList(),
 fEmPhysicsList(0),
 fDecayPhysicsList(0),
 fMes(0)
{
  ...
  fMes = new PoMuSPhysicsListMessenger(this);
...
PoMuSPhysicsList::~PoMuSPhysicsList()
{
  delete fMes;
...
void PoMuSPhysicsList::ConstructParticle()
{
...
void PoMuSPhysicsList::ConstructProcess()
{
  AddTransportation();
...
void PoMuSPhysicsList::ConstructHighEnergy()
{
...
void PoMuSPhysicsList::SetGammaToMuPairFac(G4double fac)
{
...
void PoMuSPhysicsList::SetAnnihiToMuPairFac(G4double fac)
{
  G4ProcessTable* theProcessTable = G4ProcessTable::GetProcessTable();
...
void PoMuSPhysicsList::SetAnnihiToHadronFac(G4double fac)
{
  G4ProcessTable* theProcessTable = G4ProcessTable::GetProcessTable();
...
void PoMuSPhysicsList::AddPhysicsList(const G4String& name)
{
  if (verboseLevel>1) {
...
void PoMuSPhysicsList::AddStepMax()
{
