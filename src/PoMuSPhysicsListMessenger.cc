...
PoMuSPhysicsListMessenger::PoMuSPhysicsListMessenger(PoMuSPhysicsList* physL)
...
PoMuSPhysicsListMessenger::~PoMuSPhysicsListMessenger()
{
...
void PoMuSPhysicsListMessenger::SetNewValue(G4UIcommand* command,
                                          G4String newValue)
{ 
